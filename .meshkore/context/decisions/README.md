...
| [Every launch registered and mineable](2026-09-26-every-launch-registered-and-mineable.md) | Adopted | No unpaid admission — the script refuses an all-zero registration; the platform's launches pay like anyone's; every listed launch is mined from the site; one button pays, certifies and announces |
