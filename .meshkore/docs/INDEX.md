...
- [test-results.md](test-results.md) — what is tested, what testing found, and the latest numbers.
...
Current behavior lives in [PROTOCOL.md](../../PROTOCOL.md). Standing context is
under [context/](../context/overview.md); historical ADRs are indexed in
[decisions/](../context/decisions/README.md). Tasks and initiatives carry execution
status; this index does not duplicate it.
