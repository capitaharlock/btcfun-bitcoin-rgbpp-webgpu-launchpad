...
- [`V4` — Measure end-to-end cost, latency and epoch candidates](../../modules/validation/tasks/V4-benchmark-transactions-and-derive-a-viab.md)
...
- [`V8` — Bitcoin clock, SPV, freshness and dual-chain reorg policy](../../modules/validation/tasks/V8-bitcoin-clock-spv-freshness-and-dual-chain-reorg-policy.md)
