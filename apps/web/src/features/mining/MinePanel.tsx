 ...
 * the mint script evaluates (`domain/protocol/standard.ts`, checked against the script's
 * vectors), so what this panel shows is exactly what a mint will claim — and
 * the mint script will refuse any other amount.
 */

import type { UseMiningSession } from "@/app/hooks/useMiningSession";
import type { BackendChoice } from "@/app/mining/session";
import { bytesToHex } from "@/domain/codec";
import { atoms, count, group, rate, shortHash } from "@/ui/format";
import { DECIMALS, MIN_CLZ } from "@/domain/protocol";
import type { Ticket } from "@/domain/mining";
