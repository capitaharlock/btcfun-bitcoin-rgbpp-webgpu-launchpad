...
import { statusOf, type Loop, type LoopState, type LoopStep, type Trace } from "@/domain/mining";
import { DECIMALS, MIN_CLZ } from "@/domain/protocol";

/** The parts of the mining loop (`app/hooks/useMiningLoop`) the words are read from. */
