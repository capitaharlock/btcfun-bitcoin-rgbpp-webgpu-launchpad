 ...
 *
 * A bid locks nothing (`domain/market/bid.ts`). Meeting it means signing an
...
import type { PublishedBid } from "@/app/hooks/useMarket";
...
import { atoms, group, parseAmount, satsPerToken, shortHash } from "@/ui/format";
import { readiness } from "@/domain/market";
import { unitPrice } from "@/domain/market";
import type { TokenCell } from "@/domain/rgbpp";
import { DECIMALS } from "@/domain/protocol";
import type { Operation } from "@/app/providers/TokensProvider";
