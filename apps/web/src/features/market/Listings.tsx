 ...
 *
 * A listing is a seller-signed half of a Bitcoin transaction (`domain/rgbpp/
...
import { asOrder, type OpenListing } from "@/app/hooks/useMarket";
import type { MarketActions } from "@/app/hooks/useMarketActions";
import { atoms, group, satsPerToken, shortHash } from "@/ui/format";
