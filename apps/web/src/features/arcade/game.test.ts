...
import { bombRect, canRestart, createGame, EXTRA_LIFE_EVERY, FIELD_MAX, GAME_TIMING, gameBounds, GAME_TOP, IDLE, living, marchInterval, stepGame, togglePause, ufoRect, waveGrid, type Controls, type Game } from "./game";
import { bunkerY } from "./scene/bunker";
import { CANNON_SIZE, type InvaderSpec } from "./scene";
import { cannonY, formationHeight, formationWidth, invaderRect, SPRITE_W, STEP_Y } from "./scene/geometry";
