 ...
 * show a dash until they arrive. A simulated example (`domain/launches/showcase.ts`) is
...
import type { CatalogueEntry } from "@/domain/launches";
import type { LaunchStats } from "@/app/hooks/useLaunchStats";
import { atoms, compact, group } from "@/ui/format";
import { DECIMALS, reward } from "@/domain/protocol";
import { HalvingBar } from "@/features/launch/HalvingBar";
import { ExplorerLinks, launchExplorers, offExplorers, ProjectLinks } from "@/features/launch/Links";
