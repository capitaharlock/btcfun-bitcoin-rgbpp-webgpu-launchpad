 ...
 * missing. `hooks/useMiningLoop.ts` feeds it the live wallet and fee rate.
 */

import type { Utxo } from "../bitcoin/provider";
import { ARM_SHAPE, fundingNeeded, mintShape, networkFee, plainFunding, shapeOf } from "../rgbpp/bitcoin";
import type { RgbppConfig } from "../rgbpp/config";
import type { LaunchTerms } from "../rgbpp/launch";
import { planArm, planMint, planTicket, SEAL_SATS, type MinerCell, type Paymaster, type Plan, type TokenCell } from "../rgbpp/operations";
