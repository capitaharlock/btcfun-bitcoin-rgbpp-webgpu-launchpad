 ...
 * (`lib/market/trades.ts`) — the `fill` event that points at it is a hint
...
import { feed, faultIn, type ActivityEntry, type ActivityKind } from "../lib/activity";
import { addressOfIdentity, getTx, isSpent, type ChainTx } from "../lib/bitcoin";
import { readBid, type Bid } from "../lib/market/bid";
import { compareRate, type Order } from "../lib/market/book";
import { bidStatus, tradeOf, type BidStatus, type Trade } from "../lib/market/trades";
