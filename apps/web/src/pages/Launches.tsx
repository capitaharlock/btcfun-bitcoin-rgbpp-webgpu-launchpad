 ...
 * exists, is put first as the place to start (`domain/launches/featured.ts`).
 *
 * Under them, a few simulated examples (`domain/launches/showcase.ts`) show what a launch
...
import { showcase } from "@/domain/launches";
import { useActivity, useLaunchActivity } from "@/app/hooks/useActivity";
import { useLaunches, useTip } from "@/app/hooks/useLaunches";
import { useLaunchesStats } from "@/app/hooks/useLaunchStats";
import { compact, group } from "@/ui/format";
import { featuredLaunch } from "@/domain/launches";
import { DECIMALS, HALVING_BLOCKS, MIN_CLZ, PLATFORM_PERCENT, TICKET_SATS } from "@/domain/protocol";
import { useLaunchRegistry } from "@/app/providers/LaunchesProvider";
import { ArcadeScene } from "@/features/arcade/ArcadeScene";
import { RewardChart } from "@/features/launch/RewardChart";
import { More, Panel, SectionHead } from "@/ui/primitives";
import { actionFor, TokenCard, type CardAction } from "@/features/launches/TokenCard";
import "@/features/launches/launches.css";
