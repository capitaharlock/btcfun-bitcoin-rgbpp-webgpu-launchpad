 ...
 * derived step (`domain/mining/loop.ts`) and the same mining session, so they can
 ...
 * (`domain/mining/costs.ts`): a short wallet signs nothing and is told how much
 * is missing.
 *
...
import { narrate, type Narration } from "@/app/mining/narration";
import { strippedTx } from "@/domain/rgbpp";
import { ACTIVE_RGBPP } from "@/domain/rgbpp";
import { mintScript } from "@/domain/rgbpp";
...
export type { Costs } from "@/domain/mining";
