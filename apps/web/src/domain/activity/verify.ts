...
import { canonicalDigest, canonicalId, IDENTITY_PATTERN, type Field } from "@/domain/codec";
import { verifySignature } from "@/domain/codec";
 ...
 * (`domain/launches/extras.ts` bounds those so the whole event still fits the
