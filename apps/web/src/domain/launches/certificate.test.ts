...
import { admissionBytes, admitted, certificateMessage, REGISTRATION_SATS, registrationCommitment, registrationFault, signCertificate, TEST_CERT_KEY, TEST_CERT_SECRET } from "./certificate";
