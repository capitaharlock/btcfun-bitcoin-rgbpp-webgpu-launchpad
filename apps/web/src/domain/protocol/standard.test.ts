...
import { recompute } from "@/domain/mining";
import { blocksToNextHalving, halvingsAt, HALVING_BLOCKS, MIN_CLZ, reward, terminalHalving, ticketChallenge, UNIT, TICKET_SATS, PAYMASTER_BUDGET_SATS, PLATFORM_PERCENT, NEW_CELL, REUSE, ANCHOR_GRACE_BLOCKS } from "./standard";
